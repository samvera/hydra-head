...
Gem::Specification.new do |s|
  ...
  s.files = ['lib/hydra_head.rb', 'lib/hydra_head/version.rb', 'lib/hydra/head.rb']
  s.require_paths = ["lib"]
  s.license = "APACHE2"
  ...
  s.add_dependency('hydra-access-controls', HydraHead.version)
  s.add_dependency('hydra-core', HydraHead.version)
