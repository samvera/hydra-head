...
Underneath a Hydra Head, content is stored in a Fedora Repository and indexed in Solr.  You can set up any number of Hydra Heads on top of one Fedora Repository.  This allows you to expose the same body of content to many different people in a wide variety of ways...hence the name _Hydra_: *One Body, Many Heads*
